              ...
              {trustBadge.icons && (
                <div className="flex gap-1">
                  {trustBadge.icons.map((icon, index) => (
                    <span key={index} className="text-violet-300">{icon}</span>
                  ))}
                </div>
              )}
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          ...
          {headline && (
            <div className="space-y-2">
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-purple-300 via-violet-400 to-indigo-400 bg-clip-text text-transparent animate-fade-in-up animation-delay-400">
                {headline.line2}
              </h1>
            </div>
          )}
